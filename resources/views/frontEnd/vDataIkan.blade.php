                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-body text-center">
                                                <h2 class="h5"><a href="/Data/{{ $Datas[0]->slug }}"
                                                        rel="bookmark" class="text-dark">{{ $Datas[0]->nama_kelompok }}</a>
                                                </h2>
                                                    ...
                                                    <table>
                                                        <td>
                                                            <tr> Kategori : 
                                                                ...
                                                                <span class="badge bg-primary mx-3"><a href="/Data/Ikan/{{ $kategori->nama }}" class="text-white "><b>{{ $kategori->nama }}</b></a></span>
                                                                @endforeach
                                                        </td>
                                                    </table>
                                                </div>
                                                    ...
                                                    <table>
                                                        <td>
                                                            <tr>Jenis Ikan : 
                                                                ...
                                                                <span class="badge bg-primary mx-3"><a href="/Data/Ikan/{{ $ikan->ikan_slug }}" class="text-white "><b>{{ $ikan->ikan_nama }}</b></a></span>
                                                                @endforeach
                                                            </tr>
                                                        </td>
                                                    </table>
                                    ...
                                    <div class="card">
                                        <div class="position-absolute p-2 text-white" style="background-color: rgba(0, 0,0, 0.8)">
                                            <a href="/Data/Kategori/${
                                              data[i].slug_category
                                            }" class="text-white text-decoration-none">
                                                ${data[i].category_nama}
                                            </a>
                                        </div>
                                        <a href="/Data/${
                                          data[i].slug
